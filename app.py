...
def fetch_organizations():
    ...
    url = "http://ris-oparl.itk-rheinland.de/Oparl/bodies/0013/organizations/?created_since=2025-11-06"
    try:
...
def fetch_people():
    ...
    url = "http://ris-oparl.itk-rheinland.de/Oparl/bodies/0013/people/?created_since=2025-11-06"
    try:
        response = requests.get(url, timeout=10)
        response.raise_for_status()
        return response.json()
